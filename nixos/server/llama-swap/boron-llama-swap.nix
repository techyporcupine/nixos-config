{
  let
    # mkCmd: server:list -> args:list -> single-line string
    mkCmd = server: args: builtins.concatStringsSep " " (builtins.concatLists [ server args ]);
  in
  {
    macros = {
      "llama-server" = [
